...
<div class="card"><h3>Profile</h3><p><a href="/hotel_management_system/profile.php">Manage Profile</a></p></div>
</div>
<div class="list">
...
while ($row = $res->fetch_assoc()) {
    echo "<tr style='border-top:1px solid #eee;'><td>{$row['id']}</td><td>".htmlspecialchars($row['room_no'])."</td><td>".fmtDateDisplay($row['checkin'])." to ".fmtDateDisplay($row['checkout'])."</td><td>{$row['status']}</td></tr>";
}
?>
</tbody>
</table>
